    ...
    <div style={styles.appContainer}>
      ...
      <div style={styles.workspaceBodyWrapper}>
        <div style={styles.dataLogTableCanvasCard}>
          ...
          {selectedIdentifiers.length > 0 && viewMode === 'Active' && (
            ...
            <table style={styles.ledgerTableMarkup}>
              <thead>
                <tr style={styles.tableHeadBorderRow}>
                  ...
                  <th style={{ ...styles.tableHeaderColumnCell, width: '120px', paddingLeft: viewMode === 'Archived' ? '20px' : '0' }}>SERVICE ID</th>
              ...
              <tbody>
                {servicesList.map((service) => (
                  <tr key={service.Serv_ID} style={styles.tableBodyDataRow}>
                    ...
                    <td style={{...styles.tableBodyCellBlock, paddingLeft: viewMode === 'Archived' ? '20px' : '0'}}><strong>{service.Serv_ID}</strong></td>
                ...
                {servicesList.length === 0 && (
                  <tr><td colSpan="5" style={{textAlign: 'center', padding: '20px', color: '#64748b'}}>No services found.</td></tr>
                )}
              </tbody>
            </table>
          </div>
